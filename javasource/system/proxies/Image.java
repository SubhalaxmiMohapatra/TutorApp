...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.ImageUpload", mendixObject.getType()))
			return myfirstmodule.proxies.ImageUpload.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Registration_teacher", mendixObject.getType()))
			return myfirstmodule.proxies.Registration_teacher.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Student_Reg", mendixObject.getType()))
