...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Entity_2", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.course_upload", mendixObject.getType()))
